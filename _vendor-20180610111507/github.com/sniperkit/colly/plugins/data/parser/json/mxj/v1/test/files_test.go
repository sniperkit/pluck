...
func TestNewJsonFile(t *testing.T) {
	...
	am, err := NewMapsFromJsonFile("test/data/files_test.json")
	if err != nil {
		t.Fatal(err.Error())
	}
	for _, v := range am {
...
func TestNewJsonFileRaw(t *testing.T) {
	...
	mr, err := NewMapsFromJsonFileRaw("test/data/files_test.json")
	if err != nil {
		t.Fatal(err.Error())
	}
	for _, v := range mr {
...
func TestNewXmFile(t *testing.T) {
	...
	am, err := NewMapsFromXmlFile("test/data/files_test.xml")
	if err != nil {
		t.Fatal(err.Error())
	}
	for _, v := range am {
	...
	am, err = NewMapsFromXmlFile("test/data/files_test.badxml")
	if err == nil {
		t.Fatal("no error returned for read of badjson file")
	}
	fmt.Println("caught error: ", err.Error())
...
func TestNewXmFileRaw(t *testing.T) {
	...
	mr, err := NewMapsFromXmlFileRaw("test/data/files_test.xml")
	if err != nil {
		t.Fatal(err.Error())
	}
	for _, v := range mr {
	...
	mr, err = NewMapsFromXmlFileRaw("test/data/files_test.badxml")
	if err == nil {
		t.Fatal("no error returned for read of badjson file")
	}
	fmt.Println("caught error: ", err.Error())
...
func TestJsonFile(t *testing.T) {
	...
	err = am.JsonFile("test/data/files_test_dup.json")
	if err != nil {
		t.Fatal(err.Error())
	}
	fmt.Println("test/data/files_test_dup.json written")

	err = am.JsonFileIndent("files_test_indent.json", "", "  ")
	if err != nil {
		t.Fatal(err.Error())
	}
	fmt.Println("test/data/files_test_indent.json written")
}
...
func TestXmlFile(t *testing.T) {
	...
	err = am.XmlFile("test/data/files_test_dup.xml")
	if err != nil {
		t.Fatal(err.Error())
	}
	fmt.Println("test/data/files_test_dup.xml written")

	err = am.XmlFileIndent("test/data/files_test_indent.xml", "", "  ")
	if err != nil {
		t.Fatal(err.Error())
	}
	fmt.Println("test/data/files_test_indent.xml written")
}
