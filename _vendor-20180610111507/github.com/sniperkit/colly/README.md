...
[![GoDoc](https://godoc.org/github.com/sniperkit/colly/pkg?status.svg)](https://godoc.org/github.com/sniperkit/colly/pkg)
...
[![view examples](https://img.shields.io/badge/learn%20by-examples-0077b3.svg?style=flat-square)](https://github.com/sniperkit/colly/pkg/tree/master/_examples)
...
See [examples folder](https://github.com/sniperkit/colly/pkg/tree/master/_examples) for more detailed examples.


## Installation

```
go get -u github.com/sniperkit/colly/pkg/...
```


## Bugs

Bugs or suggestions? Visit the [issue tracker](https://github.com/sniperkit/colly/pkg/issues) or join `#colly` on freenode
...
<a href="https://github.com/sniperkit/colly/pkg/graphs/contributors"><img src="https://opencollective.com/colly/contributors.svg?width=890" /></a>
